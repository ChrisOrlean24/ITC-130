...
class GradeEntryTile extends StatelessWidget {
  ...
  /// Optional secondary label (e.g. "5 pts" for oral recitation)
  final String? label2;

  /// Score and total — shown as "score/total" if provided
  final int? score;
  final int? total;

  /// Percentage 0–100 — shown as color-coded bar if provided
  final double? percentage;

  /// Status label with color (e.g. "Present" in green)
  ...
  Widget build(BuildContext context) {
    ...
    final scoreColor =
        pct != null ? AppTheme.gradeColor(pct) : AppTheme.accent;
