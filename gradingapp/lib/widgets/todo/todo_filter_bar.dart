    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          _FilterChip(
            label: 'All',
            isSelected: statusFilter == null && priorityFilter == null,
            onTap: () {
          ...
          _FilterChip(
            ...
            onTap: () {
              ref.read(todoPriorityFilterProvider.notifier).state = TodoPriority.high;
              ref.read(todoStatusFilterProvider.notifier).state = null;
            },
          ),
          const SizedBox(width: 8),
          _FilterChip(
            ...
            onTap: () {
              ref.read(todoPriorityFilterProvider.notifier).state = TodoPriority.medium;
              ref.read(todoStatusFilterProvider.notifier).state = null;
            },
          ),
          const SizedBox(width: 8),
          _FilterChip(
            ...
            onTap: () {
              ref.read(todoPriorityFilterProvider.notifier).state = TodoPriority.low;
              ref.read(todoStatusFilterProvider.notifier).state = null;
            },
          ),
        ],
